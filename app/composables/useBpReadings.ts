...
export function getBpCategory(systolic: number, diastolic: number): BpCategory {
  ...
  if (systolic >= 160 || diastolic >= 100) return 'hipertension-2'
  if (systolic >= 140 || diastolic >= 90) return 'hipertension-1'
...
export const BP_CATEGORIES: Record<BpCategory, BpCategoryInfo> = {
  'normal': {
    label: 'Normal',
    color: 'success',
    description: 'Sistólica < 130 y Diastólica < 90'
  },
  'elevada': {
    label: 'Elevada',
    color: 'warning',
    description: 'Sistólica 130–139 y Diastólica < 90'
  },
  'hipertension-1': {
    label: 'Hipertensión I',
    color: 'error',
    description: 'Sistólica 140–159 o Diastólica 90–99'
  },
  'hipertension-2': {
    label: 'Hipertensión II',
    color: 'error',
    description: 'Sistólica ≥ 160 o Diastólica ≥ 100'
  },
  'crisis': {
    label: 'Crisis hipertensiva',
    color: 'error',
    description: 'Sistólica > 180 o Diastólica > 120'
  }
}
